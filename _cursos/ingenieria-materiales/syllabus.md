...
Seleccionar materiales óptimos para procesos industriales mediante el análisis de propiedades, comportamiento y normatividad, considerando criterios de funcionalidad, relación costo/desempeño e impacto ambiental, para contribuir al desarrollo de productos que satisfagan los requerimientos del cliente, garantizando la rentabilidad industrial y promoviendo la sustentabilidad.
...
**Unidad 0: Introducción a la Ingeniería de Materiales** (1 sesión)  
...
- Portafolio de fichas técnicas de materiales (10%)
- Reportes de prácticas de laboratorio (10%)
- Ejercicios de aplicación y problemas resueltos (10%)
- Participación en discusiones y foros (5%)
- Autoevaluación y coevaluación (5%)

**Evaluación Sumativa (60%)**:

- Evaluación teórico-práctica Unidad I (15%)
- Evaluación teórico-práctica Unidad II (15%)
...
3. Evaluación sumativa al finalizar la Unidad I (semana 6)
4. Evaluación sumativa al finalizar la Unidad II (semana 14)
5. Proyecto integrador (inicia semana 10, entrega final semana 15)
6. Determinación del nivel de desempeño final (NA, SA, DE, AU)
...
## 8. Cronograma y Contenidos (15 Sesiones)

| Semana | Sesión | Unidad Temática | Contenidos Clave | Actividades Sugeridas | Evaluación Asociada |
|--------|--------|-----------------|------------------|------------------------|----------------------|
| 1 | 1 | U0: Introducción a la Ingeniería de Materiales | Presentación del curso. Interrelaciones entre composición, estructura, síntesis, procesamiento y funcionamiento. Importancia en contexto industrial. | Presentación interactiva. Discusión sobre impacto de materiales en productos cotidianos. Cuestionario diagnóstico. | Diagnóstica |
| 2 | 2 | U1: Propiedades Físicas | Propiedades mecánicas (resistencia, dureza, tenacidad). Propiedades térmicas (conductividad, expansión). | Exposición. Demostración de propiedades. Ejercicios de identificación. Introducción al uso de bases de datos. | |
| 3 | 3 | U1: Propiedades Físicas | Propiedades eléctricas y magnéticas. Propiedades ópticas. | Exposición. Ejercicios de categorización. Análisis de aplicaciones industriales según propiedades. | |
| 4 | 4 | U1: Propiedades Químicas | Estructura atómica, enlaces. Reactividad, oxidación, corrosión. | Exposición. Ejercicios de identificación. Demostración de procesos de corrosión. | |
| 5 | 5 | U1: Propiedades Tecnológicas | Conformabilidad, ductibilidad, fusibilidad, colabilidad, soldabilidad, templabilidad, maquinabilidad. Propiedades organolépticas. | Exposición. Análisis de casos industriales. Ejercicios de categorización. | |
| 6 | 6 | U1: Clasificación y Evaluación | Clasificación integral de materiales. Pruebas destructivas y no destructivas. Integración de todas las propiedades. | Práctica de laboratorio. Elaboración de fichas técnicas completas. Discusión integradora. | Evaluación Sumativa U1 |
| 7 | 7 | U2: Introducción a la Selección | Importancia de la selección de materiales. Traducción de requisitos de diseño a propiedades de materiales. | Exposición. Análisis de casos. Ejercicios de traducción de requisitos. | |
| 8 | 8 | U2: Método Ashby I | Fundamentos del método Ashby. Mapas de propiedades. Índices de mérito. | Exposición. Ejercicios guiados con mapas de Ashby. Introducción a software/bases de datos. | |
| 9 | 9 | U2: Método Ashby II | Aplicación práctica del método Ashby. Índices de mérito para diferentes aplicaciones. | Resolución de problemas. Uso de software o bases de datos. Discusión sobre límites del método. | |
| 10 | 10 | U2: Selección por Funcionalidad | Criterios de funcionalidad. Casos prácticos de selección basada en funcionalidad. Lanzamiento del proyecto integrador. | Ejercicios de selección. Formación de equipos y asignación de proyectos. Guía para proyecto integrador. | |
| 11 | 11 | U2: Selección por Costo/Desempeño | Factores económicos en selección de materiales. Análisis costo/beneficio. Consideraciones del ciclo de vida. | Exposición. Análisis de casos. Ejercicios de cálculo de relación costo/desempeño. Seguimiento proyecto. | |
| 12 | 12 | U2: Selección por Impacto Ambiental | Evaluación del ciclo de vida. Energía embebida. Huella de carbono. Estrategias de reducción de impacto. | Exposición. Análisis de casos. Uso de bases de datos ambientales. Seguimiento proyecto. | |
| 13 | 13 | U2: Materiales Alternativos | Materiales emergentes. Bio-basados. Reciclados. Casos de sustitución exitosa. | Investigación guiada. Presentaciones breves. Discusión sobre barreras y oportunidades. Seguimiento proyecto. | |
| 14 | 14 | U2: Normatividad y Validación | Normas nacionales e internacionales. Proceso de validación de selección de materiales. Integración de criterios. | Exposición. Análisis de normas. Ejercicio de validación integral. Preparación final del proyecto. | Evaluación Sumativa U2 |
| 15 | 15 | Evaluación Final | Presentación de proyectos integradores. Discusión de resultados. Cierre del curso. | Presentaciones finales de proyectos. Retroalimentación. Reflexión sobre aprendizajes clave. | Presentación de Proyecto Integrador |
